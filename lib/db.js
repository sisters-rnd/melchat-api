...
//const connectionString = 'tcp://melchatapi:itsmine1378@localhost:5432/melchat';
const connectionString = {
    host: 'localhost',
    port: 5432,
    database: 'melchat',
    user: 'melchatapi',
    password: 'itsmine1378'
};
...
class db {
    ...
    getChats (personid) {
        return this.db.any(`select chats.person_id, contacts.name, contact_types.contact_type, contacts.image, messages.sender, messages.text, messages.date, c2.id as sender_id, c2.name as sender_name
                            from chats
